...
- **Honest labels** — presets are **Stable**, **Requires validation**, or **Experimental** per `packages/registry` and `presetHasStableEvidence`. The site does not call anything production-ready without evidence.
