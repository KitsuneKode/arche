...
1. **What runtime owns your core logic?**
   - TypeScript/Node → `typescript-fullstack`, `next-app`, `convex-product`, or `tanstack-start`
   - Terminal UI → `tui-app`
...
| `next-app`             | Frontend-only Next.js without bundled API      |
| `tanstack-start`       | Full-stack React without Next.js               |
| `tui-app`              | Terminal UI with OpenTUI                       |
