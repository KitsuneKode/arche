...
const FAMILY_DIRS: Record<string, string[]> = {
  ...
  convex: ['package.json', 'tsconfig.json', 'next.config.js', ...PRODUCTION_FILES],
  rust: ['Cargo.toml'],
  polyglot: ['package.json', 'README.md'],
  cli: ['package.json', 'tsconfig.json', ...PRODUCTION_FILES],
  tui: ['package.json', 'tsconfig.json', ...PRODUCTION_FILES],
  tanstack: ['package.json', 'tsconfig.json', 'vite.config.ts', ...PRODUCTION_FILES],
...
describe('template stub file integrity', () => {
  it('standalone JavaScript templates expose generated quality gates', () => {
    const expectedScriptsByFamily: Record<string, string[]> = {
      ...
      mobile: ['check-types'],
      next: ['build', 'check-types', 'lint'],
      tui: ['build', 'check-types', 'lint'],
      tanstack: ['build', 'check-types', 'lint', 'start'],
