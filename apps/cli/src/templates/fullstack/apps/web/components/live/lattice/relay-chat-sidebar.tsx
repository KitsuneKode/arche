...
export function RelayChatSidebar({
  ...
  return (
    <div className="flex h-full min-h-[min(640px,78vh)] flex-col border border-zinc-800 bg-black">
      <div className="shrink-0 border-b border-zinc-800 bg-zinc-900/50 px-4 py-3">
        ...
        <p className="mt-1 text-sm text-zinc-400">Room feed — clashes and chat in one stream.</p>
        {stats ? (
      ...
      <div
        ref={scrollRef}
        className="flex-1 space-y-2 overflow-y-auto p-4 font-mono text-xs"
        role="log"
        aria-live="polite"
      >
