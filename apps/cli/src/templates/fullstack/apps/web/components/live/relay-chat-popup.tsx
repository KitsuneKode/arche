      ...
      {open ? (
        <div className="fixed inset-0 z-50 flex items-end justify-end p-4 md:items-center">
          ...
          <dialog
            ...
            className="relative flex h-[min(55vh,520px)] w-full max-w-md flex-col border border-zinc-700 bg-black p-0 shadow-2xl motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-bottom-4 md:h-[min(72vh,640px)]"
          >
