  ...
  return (
    ...
    >
      <input
        ...
        autoFocus={autoFocus}
        data-chat-input=""
        className="min-w-0 flex-1 border border-zinc-800 bg-zinc-950 px-3 py-2 font-mono text-sm text-white outline-none ring-amber-500/40 focus:ring-1 disabled:opacity-60"
